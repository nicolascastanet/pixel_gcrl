...
class Maze:
    ...
    def sample_start(self):
        ...
        s_square = self.start_squares[self.np_random.integers(low=0, high=len(self.start_squares))]
    ...
    def sample_goal(self, min_wall_dist=None):
        ...
        g_square = self.goal_squares[self.np_random.integers(low=0, high=len(self.goal_squares))]
...
segments_c = [
    dict(name='A', anchor='origin', direction='down', times=10),
    dict(name='B', anchor='A9', direction='right', times=4),
    dict(name='C', anchor='B3', direction='up', times=10),
    dict(name='D', anchor='C9', direction='right', times=4),
    dict(name='E', anchor='D3', direction='down', times=10)
]
mazes_dict['square_c'] = {'maze': Maze(*segments_c, goal_squares=['e8', 'e9']), 'action_range': 0.95}
...
mazes_dict['square_c2'] = {'maze': Maze(*segments_c2, goal_squares=['e2', 'e3']), 'action_range': 0.95}
...
mazes_dict['square_large_0'] = {'maze': Maze(*segments_crazy_0, goal_squares='9,9'), 'action_range': 0.95}


segments_crazy_1 = [
    {'name': '1,0', 'anchor': 'origin', 'direction': 'right'},
    {'name': '1,1', 'anchor': '1,0', 'direction': 'up'},
    {'name': '1,2', 'anchor': '1,1', 'direction': 'up'},
    ...
    {'name': '0,2', 'anchor': '1,2', 'direction': 'left'},
    {'name': '3,2', 'anchor': '3,1', 'direction': 'up'},
    {'name': '2,2', 'anchor': '1,2', 'direction': 'right'},
    {'name': '3,3', 'anchor': '3,2', 'direction': 'up'},
    {'name': '3,4', 'anchor': '3,3', 'direction': 'up'},
    {'name': '4,4', 'anchor': '3,4', 'direction': 'right'},
    {'name': '1,3', 'anchor': '1,2', 'direction': 'up'},
    {'name': '0,3', 'anchor': '1,3', 'direction': 'left'},
    {'name': '2,3', 'anchor': '3,3', 'direction': 'left'},
    {'name': '1,4', 'anchor': '1,3', 'direction': 'up'},
    {'name': '4,3', 'anchor': '4,4', 'direction': 'down'},
    {'name': '5,4', 'anchor': '4,4', 'direction': 'right'},
    {'name': '3,0', 'anchor': '3,1', 'direction': 'down'},
    {'name': '4,0', 'anchor': '3,0', 'direction': 'right'},
    {'name': '3,5', 'anchor': '3,4', 'direction': 'up'},
    {'name': '4,1', 'anchor': '4,0', 'direction': 'up'},
    {'name': '5,1', 'anchor': '4,1', 'direction': 'right'},
    {'name': '6,4', 'anchor': '5,4', 'direction': 'right'},
    {'name': '4,2', 'anchor': '4,1', 'direction': 'up'},
    {'name': '0,4', 'anchor': '0,3', 'direction': 'up'},
    {'name': '2,5', 'anchor': '3,5', 'direction': 'left'},
    {'name': '6,5', 'anchor': '6,4', 'direction': 'up'},
    {'name': '5,0', 'anchor': '4,0', 'direction': 'right'},
    {'name': '2,6', 'anchor': '2,5', 'direction': 'up'},
    {'name': '5,5', 'anchor': '5,4', 'direction': 'up'},
    {'name': '2,7', 'anchor': '2,6', 'direction': 'up'},
    {'name': '5,2', 'anchor': '5,1', 'direction': 'up'},
    {'name': '6,0', 'anchor': '5,0', 'direction': 'right'},
    {'name': '6,3', 'anchor': '6,4', 'direction': 'down'},
    {'name': '6,1', 'anchor': '5,1', 'direction': 'right'},
    {'name': '0,5', 'anchor': '0,4', 'direction': 'up'},
    {'name': '4,5', 'anchor': '5,5', 'direction': 'left'},
    {'name': '1,6', 'anchor': '2,6', 'direction': 'left'},
    {'name': '6,6', 'anchor': '6,5', 'direction': 'up'},
    {'name': '7,4', 'anchor': '6,4', 'direction': 'right'},
    {'name': '2,8', 'anchor': '2,7', 'direction': 'up'},
    {'name': '0,6', 'anchor': '1,6', 'direction': 'left'},
    {'name': '7,1', 'anchor': '6,1', 'direction': 'right'},
    {'name': '2,4', 'anchor': '2,3', 'direction': 'up'},
    {'name': '8,4', 'anchor': '7,4', 'direction': 'right'},
    {'name': '8,3', 'anchor': '8,4', 'direction': 'down'},
    {'name': '8,5', 'anchor': '8,4', 'direction': 'up'},
    {'name': '8,1', 'anchor': '7,1', 'direction': 'right'},
    {'name': '5,6', 'anchor': '5,5', 'direction': 'up'},
    {'name': '9,5', 'anchor': '8,5', 'direction': 'right'},
    {'name': '1,7', 'anchor': '2,7', 'direction': 'left'},
    {'name': '1,5', 'anchor': '2,5', 'direction': 'left'},
    {'name': '3,7', 'anchor': '2,7', 'direction': 'right'},
    {'name': '6,2', 'anchor': '5,2', 'direction': 'right'},
    {'name': '7,5', 'anchor': '7,4', 'direction': 'up'},
    {'name': '5,3', 'anchor': '4,3', 'direction': 'right'},
    {'name': '9,4', 'anchor': '8,4', 'direction': 'right'},
    {'name': '8,6', 'anchor': '8,5', 'direction': 'up'},
    {'name': '2,9', 'anchor': '2,8', 'direction': 'up'},
    {'name': '4,7', 'anchor': '3,7', 'direction': 'right'},
    {'name': '7,0', 'anchor': '7,1', 'direction': 'down'},
    {'name': '1,9', 'anchor': '2,9', 'direction': 'left'},
    {'name': '3,6', 'anchor': '3,7', 'direction': 'down'},
    {'name': '4,6', 'anchor': '5,6', 'direction': 'left'},
    {'name': '9,3', 'anchor': '9,4', 'direction': 'down'},
    {'name': '4,8', 'anchor': '4,7', 'direction': 'up'},
    {'name': '4,9', 'anchor': '4,8', 'direction': 'up'},
    {'name': '6,7', 'anchor': '6,6', 'direction': 'up'},
    {'name': '7,3', 'anchor': '8,3', 'direction': 'left'},
    {'name': '0,9', 'anchor': '1,9', 'direction': 'left'},
    {'name': '9,6', 'anchor': '8,6', 'direction': 'right'},
    {'name': '0,7', 'anchor': '0,6', 'direction': 'up'},
    {'name': '8,2', 'anchor': '8,1', 'direction': 'up'},
    {'name': '8,7', 'anchor': '8,6', 'direction': 'up'},
    {'name': '3,8', 'anchor': '3,7', 'direction': 'up'},
    {'name': '0,8', 'anchor': '0,9', 'direction': 'down'},
    {'name': '9,1', 'anchor': '8,1', 'direction': 'right'},
    {'name': '6,8', 'anchor': '6,7', 'direction': 'up'},
    {'name': '9,2', 'anchor': '8,2', 'direction': 'right'},
    {'name': '8,0', 'anchor': '8,1', 'direction': 'down'},
    {'name': '1,8', 'anchor': '1,7', 'direction': 'up'},
    {'name': '5,9', 'anchor': '4,9', 'direction': 'right'},
    {'name': '3,9', 'anchor': '2,9', 'direction': 'right'},
    {'name': '7,8', 'anchor': '6,8', 'direction': 'right'},
    {'name': '7,2', 'anchor': '6,2', 'direction': 'right'},
    {'name': '7,6', 'anchor': '8,6', 'direction': 'left'},
    {'name': '5,7', 'anchor': '5,6', 'direction': 'up'},
    {'name': '7,7', 'anchor': '8,7', 'direction': 'left'},
    {'name': '9,0', 'anchor': '9,1', 'direction': 'down'},
    {'name': '9,7', 'anchor': '9,6', 'direction': 'up'},
    {'name': '8,8', 'anchor': '7,8', 'direction': 'right'},
    {'name': '5,8', 'anchor': '5,9', 'direction': 'down'},
    {'name': '6,9', 'anchor': '6,8', 'direction': 'up'},
    {'name': '7,9', 'anchor': '7,8', 'direction': 'up'},
    {'name': '8,9', 'anchor': '7,9', 'direction': 'right'},
    {'name': '9,9', 'anchor': '8,9', 'direction': 'right'},
    {'name': '9,8', 'anchor': '8,8', 'direction': 'right'}]
mazes_dict['square_large_1'] = {'maze': Maze(*segments_crazy_1, goal_squares='9,9'), 'action_range': 0.95}
...
segments_crazy_2 = [
    ...
    {'name': '2,1', 'anchor': '2,0', 'direction': 'up'},
    {'name': '3,1', 'anchor': '2,1', 'direction': 'right'},
    {'name': '1,1', 'anchor': '2,1', 'direction': 'left'},
    {'name': '0,2', 'anchor': '0,1', 'direction': 'up'},
    {'name': '0,3', 'anchor': '0,2', 'direction': 'up'},
    {'name': '3,0', 'anchor': '2,0', 'direction': 'right'},
    {'name': '1,3', 'anchor': '0,3', 'direction': 'right'},
    {'name': '1,2', 'anchor': '0,2', 'direction': 'right'},
    {'name': '4,1', 'anchor': '3,1', 'direction': 'right'},
    {'name': '4,2', 'anchor': '4,1', 'direction': 'up'},
    {'name': '2,3', 'anchor': '1,3', 'direction': 'right'},
    {'name': '3,2', 'anchor': '3,1', 'direction': 'up'},
    {'name': '5,2', 'anchor': '4,2', 'direction': 'right'},
    {'name': '2,4', 'anchor': '2,3', 'direction': 'up'},
    {'name': '1,4', 'anchor': '2,4', 'direction': 'left'},
    {'name': '2,5', 'anchor': '2,4', 'direction': 'up'},
    {'name': '2,2', 'anchor': '3,2', 'direction': 'left'},
    {'name': '5,3', 'anchor': '5,2', 'direction': 'up'},
    {'name': '0,4', 'anchor': '0,3', 'direction': 'up'},
    {'name': '5,1', 'anchor': '5,2', 'direction': 'down'},
    {'name': '6,1', 'anchor': '5,1', 'direction': 'right'},
    {'name': '3,4', 'anchor': '2,4', 'direction': 'right'},
    {'name': '4,4', 'anchor': '3,4', 'direction': 'right'},
    {'name': '1,5', 'anchor': '2,5', 'direction': 'left'},
    {'name': '4,0', 'anchor': '3,0', 'direction': 'right'},
    {'name': '7,1', 'anchor': '6,1', 'direction': 'right'},
    ...
    {'name': '2,6', 'anchor': '2,5', 'direction': 'up'},
    {'name': '3,5', 'anchor': '3,4', 'direction': 'up'},
    {'name': '3,6', 'anchor': '2,6', 'direction': 'right'},
    {'name': '0,5', 'anchor': '1,5', 'direction': 'left'},
    {'name': '4,6', 'anchor': '3,6', 'direction': 'right'},
    {'name': '3,7', 'anchor': '3,6', 'direction': 'up'},
    {'name': '3,3', 'anchor': '4,3', 'direction': 'left'},
    {'name': '1,6', 'anchor': '1,5', 'direction': 'up'},
    {'name': '5,0', 'anchor': '4,0', 'direction': 'right'},
    {'name': '6,3', 'anchor': '5,3', 'direction': 'right'},
    {'name': '5,4', 'anchor': '5,3', 'direction': 'up'},
    {'name': '6,2', 'anchor': '6,3', 'direction': 'down'},
    {'name': '0,6', 'anchor': '1,6', 'direction': 'left'},
    {'name': '7,2', 'anchor': '7,1', 'direction': 'up'},
    {'name': '7,3', 'anchor': '7,2', 'direction': 'up'},
    {'name': '6,0', 'anchor': '6,1', 'direction': 'down'},
    {'name': '8,2', 'anchor': '7,2', 'direction': 'right'},
    {'name': '1,7', 'anchor': '1,6', 'direction': 'up'},
    {'name': '9,2', 'anchor': '8,2', 'direction': 'right'},
    {'name': '6,4', 'anchor': '6,3', 'direction': 'up'},
    {'name': '8,1', 'anchor': '7,1', 'direction': 'right'},
    {'name': '8,0', 'anchor': '8,1', 'direction': 'down'},
    {'name': '5,6', 'anchor': '4,6', 'direction': 'right'},
    {'name': '4,7', 'anchor': '4,6', 'direction': 'up'},
    {'name': '5,5', 'anchor': '5,4', 'direction': 'up'},
    {'name': '7,0', 'anchor': '8,0', 'direction': 'left'},
    {'name': '6,6', 'anchor': '5,6', 'direction': 'right'},
    {'name': '3,8', 'anchor': '3,7', 'direction': 'up'},
    {'name': '6,7', 'anchor': '6,6', 'direction': 'up'},
    {'name': '4,5', 'anchor': '5,5', 'direction': 'left'},
    {'name': '5,7', 'anchor': '6,7', 'direction': 'left'},
    {'name': '7,4', 'anchor': '7,3', 'direction': 'up'},
    {'name': '8,3', 'anchor': '7,3', 'direction': 'right'},
    {'name': '2,7', 'anchor': '1,7', 'direction': 'right'},
    {'name': '9,1', 'anchor': '8,1', 'direction': 'right'},
    {'name': '0,7', 'anchor': '0,6', 'direction': 'up'},
    {'name': '6,8', 'anchor': '6,7', 'direction': 'up'},
    {'name': '9,0', 'anchor': '8,0', 'direction': 'right'},
    {'name': '7,8', 'anchor': '6,8', 'direction': 'right'},
    {'name': '0,8', 'anchor': '0,7', 'direction': 'up'},
    {'name': '6,9', 'anchor': '6,8', 'direction': 'up'},
    {'name': '7,9', 'anchor': '7,8', 'direction': 'up'},
    {'name': '8,4', 'anchor': '8,3', 'direction': 'up'},
    {'name': '5,9', 'anchor': '6,9', 'direction': 'left'},
    {'name': '8,8', 'anchor': '7,8', 'direction': 'right'},
    {'name': '4,9', 'anchor': '5,9', 'direction': 'left'},
    {'name': '7,5', 'anchor': '7,4', 'direction': 'up'},
    {'name': '0,9', 'anchor': '0,8', 'direction': 'up'},
    {'name': '9,3', 'anchor': '9,2', 'direction': 'up'},
    {'name': '9,4', 'anchor': '9,3', 'direction': 'up'},
    {'name': '1,8', 'anchor': '1,7', 'direction': 'up'},
    {'name': '9,5', 'anchor': '9,4', 'direction': 'up'},
    {'name': '2,8', 'anchor': '1,8', 'direction': 'right'},
    {'name': '7,6', 'anchor': '7,5', 'direction': 'up'},
    {'name': '8,5', 'anchor': '8,4', 'direction': 'up'},
    {'name': '6,5', 'anchor': '5,5', 'direction': 'right'},
    {'name': '5,8', 'anchor': '6,8', 'direction': 'left'},
    {'name': '4,8', 'anchor': '5,8', 'direction': 'left'},
    {'name': '9,6', 'anchor': '9,5', 'direction': 'up'},
    {'name': '7,7', 'anchor': '7,6', 'direction': 'up'},
    {'name': '8,9', 'anchor': '8,8', 'direction': 'up'},
    {'name': '3,9', 'anchor': '3,8', 'direction': 'up'},
    {'name': '9,8', 'anchor': '8,8', 'direction': 'right'},
    {'name': '9,9', 'anchor': '8,9', 'direction': 'right'},
    {'name': '1,9', 'anchor': '1,8', 'direction': 'up'},
    {'name': '8,7', 'anchor': '8,8', 'direction': 'down'},
    {'name': '2,9', 'anchor': '3,9', 'direction': 'left'},
    {'name': '8,6', 'anchor': '8,7', 'direction': 'down'},
    {'name': '9,7', 'anchor': '8,7', 'direction': 'right'}]
mazes_dict['square_large_2'] = {'maze': Maze(*segments_crazy_2, goal_squares='9,9'), 'action_range': 0.95}
...
mazes_dict['square_med_1'] = {'maze': Maze(*segments_med_1, goal_squares='4,4'), 'action_range': 0.95}
...
mazes_dict['square_pbcs_0'] = {'maze': Maze(*segments_pbcs_0, goal_squares='4,4'), 'action_range': 0.95}
...
segments_pbcs_2 = [
    ...
    {'anchor': '2,0', 'direction': 'right', 'name': '3,0'},
    {'anchor': '3,0', 'direction': 'right', 'name': '4,0'},
    {'anchor': '4,0', 'direction': 'right', 'name': '5,0'},
    {'anchor': '5,0', 'direction': 'up', 'name': '5,1'},
    {'anchor': '5,1', 'direction': 'left', 'name': '4,1'},
    {'anchor': '4,1', 'direction': 'up', 'name': '4,2'},
    {'anchor': '4,2', 'direction': 'left', 'name': '3,2'},
    {'anchor': '3,2', 'direction': 'left', 'name': '2,2'},
    {'anchor': '2,2', 'direction': 'down', 'name': '2,1'},
    {'anchor': '2,1', 'direction': 'right', 'name': '3,1'},
    {'anchor': '2,1', 'direction': 'left', 'name': '1,1'},
    {'anchor': '1,1', 'direction': 'up', 'name': '1,2'},
    {'anchor': '1,2', 'direction': 'left', 'name': '0,2'},
    {'anchor': '0,2', 'direction': 'down', 'name': '0,1'},
    {'anchor': '0,2', 'direction': 'up', 'name': '0,3'},
    {'anchor': '0,3', 'direction': 'right', 'name': '1,3'},
    {'anchor': '1,3', 'direction': 'right', 'name': '2,3'},
    {'anchor': '2,3', 'direction': 'up', 'name': '2,4'},
    {'anchor': '2,4', 'direction': 'up', 'name': '2,5'},
    {'anchor': '2,5', 'direction': 'left', 'name': '1,5'},
    {'anchor': '1,5', 'direction': 'left', 'name': '0,5'},
    {'anchor': '0,5', 'direction': 'down', 'name': '0,4'},
    {'anchor': '0,4', 'direction': 'right', 'name': '1,4'}, 
    {'anchor': '2,5', 'direction': 'right', 'name': '3,5'},
    {'anchor': '3,5', 'direction': 'down', 'name': '3,4'},
    {'anchor': '3,4', 'direction': 'right', 'name': '4,4'},
    {'anchor': '4,4', 'direction': 'down', 'name': '4,3'},
    {'anchor': '4,3', 'direction': 'left', 'name': '3,3'},
    {'anchor': '4,3', 'direction': 'right', 'name': '5,3'},
    {'anchor': '5,3', 'direction': 'down', 'name': '5,2'},
    {'anchor': '5,3', 'direction': 'up', 'name': '5,4'},
    {'anchor': '5,4', 'direction': 'up', 'name': '5,5'},
    {'anchor': '5,5', 'direction': 'left', 'name': '4,5'},
]

mazes_dict['square_pbcs_2'] = {'maze': Maze(*segments_pbcs_2, goal_squares='5,5'), 'action_range': 0.95}

mazes_dict['square_pbcs_1'] = {'maze': Maze(*segments_pbcs_1, goal_squares='0,3'), 'action_range': 0.95}

mazes_dict['square_e'] = {'maze': make_experiment_maze(5, 1, 5), 'action_range': 0.95}

mazes_dict['snail'] = {'maze': make_snail_maze(4), 'action_range': 0.95}


mazes_dict['snake'] = {'maze': make_snake_maze(5), 'action_range': 0.95}


#### Change Env XP #####

mazes_dict['xp_change_0'] = {'maze': make_experiment_maze(5,3,5), 'action_range': 0.95}
mazes_dict['xp_change_1'] = {'maze': make_experiment_maze(5,3,3), 'action_range': 0.95}


mazes_dict['square_pbcs_0_easy'] = {'maze': Maze(*segments_pbcs_0, goal_squares='4,4'), 'action_range': 0.2}
mazes_dict['square_pbcs_0_easy_1'] = {'maze': Maze(*segments_pbcs_0, goal_squares='4,4'), 'action_range': 0.95}
mazes_dict['square_no_walls'] = {'maze': Maze(*segments_pbcs_0, goal_squares='4,4'), 'action_range': 0.95}


walls_to_remove_pbcs_0 = [
((2.5, 3.5),(0.5, 0.5)),
((1.5, 2.5),(0.5, 0.5)),
((0.5, 0.5),(2.5, 3.5)),
((0.5, 1.5),(2.5, 2.5)),
...
for w in walls_to_remove_pbcs_0:
    mazes_dict['square_pbcs_0_easy']['maze']._walls.remove(w)

for w in walls_to_remove_pbcs_0_1:
    mazes_dict['square_pbcs_0_easy_1']['maze']._walls.remove(w)
    
for w in walls_to_remove_pbcs_0_2:
    mazes_dict['square_no_walls']['maze']._walls.remove(w)
#mazes_dict['square_no_walls']['maze']._walls = {}